          ...
          addedPhotos.map((link) => (
            <div key={link} className="h-32 relative flex">
              ...
              <button
                ...
                className="absolute bottom-1 right-1 text-white bg-black p-1 opacity-50 rounded-lg"
              >
                <svg
              ...
              <button
                ...
                className="absolute bottom-1 left-1 text-white bg-black p-1 opacity-50 rounded-lg"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
