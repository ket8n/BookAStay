// icon:person-skiing | Fontawesome https://fontawesome.com/ | Fontawesome
import * as React from "react";

function IconPersonSkiing(props) {
  return (
    <svg
      viewBox="0 0 576 512"
      fill="currentColor"
